...
from garage.sampler.batch_worker import BatchWorker
...
class LocalSampler(Sampler):
    ...
    def obtain_samples(self, itr, seq_idx, num_samples, agent_update, env_update=None):
